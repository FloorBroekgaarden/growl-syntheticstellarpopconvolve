...
.. list-table:: Public options
   ...
   * - check_convolution_config
     - Description:
       ...
       Validation:
          All(Range(min=None, max=1, min_included=True, max_included=True, msg=None), <function Boolean at 0x7ff3260d53a0>, msg=None)
   ...
   * - convolution_lookback_time_bin_edges
     - Description:
       ...
       Validation:
          <function array_validation at 0x7ff3260d5280>
   ...
   * - custom_convolution_function
     - Description:
       ...
       Validation:
          <function callable_or_none_validation at 0x7ff3260d51f0>
   ...
   * - delay_time_default_unit
     - Description:
       ...
       Validation:
          <function unit_validation at 0x7ff3260d5040>
   ...
   * - input_filename
     - Description:
       ...
       Validation:
          <function existing_path_validation at 0x7ff3260d5310>
   * - logger
     - Description:
          Logger object.
       ...
       Validation:
          <function logger_validation at 0x7ff3260d50d0>
   * - max_job_queue_size
     - Description:
