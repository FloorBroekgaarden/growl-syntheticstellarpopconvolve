...
.. list-table:: Public options
   ...
   * - check_convolution_config
     - Description:
       ...
       Validation:
          All(Range(min=None, max=1, min_included=True, max_included=True, msg=None), <function Boolean at 0x7fe7ee37ddc0>, msg=None)
   ...
   * - convolution_lookback_time_bin_edges
     - Description:
       ...
       Validation:
          <function array_validation at 0x7fe7ee37daf0>
   ...
   * - custom_convolution_function
     - Description:
       ...
       Validation:
          <function callable_or_none_validation at 0x7fe7ee37da60>
   ...
   * - delay_time_default_unit
     - Description:
       ...
       Validation:
          <function unit_validation at 0x7fe7ee37d8b0>
   ...
   * - input_filename
     - Description:
       ...
       Validation:
          <function existing_path_validation at 0x7fe7ee37de50>
   * - logger
     - Description:
          Logger object.
       ...
       Validation:
          <function logger_validation at 0x7fe7ee37d940>
   * - max_job_queue_size
     - Description:
