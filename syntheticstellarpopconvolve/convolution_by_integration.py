...
#         raise ValueError("Choice of convolution-method {} for `convolution_by_integration` is not supported. Only `convolution_direction=backward` is supported.".format(convolution_instruction['convolution_direction']))
